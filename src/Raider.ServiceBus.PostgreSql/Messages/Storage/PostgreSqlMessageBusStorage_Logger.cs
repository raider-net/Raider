...
{
	internal partial class PostgreSqlMessageBusStorage : PostgreSqlHostStorage, IHandlerMessageLogger
	{
			...
			ITransactionContext? transactionContext = null)
		{
			try
			{
				...
				if (messageStatus != MessageStatus.Unchanged)
				{
					try
					{
						UpdateMessageStatus(idMessage, messageStatus, transactionContext);
					}
					catch (Exception ex)
					{
						_baseHandlerMessageLogger.LogError(traceInfo, idMessage, messageStatus, x => x.ExceptionInfo(ex), detail, transactionContext);
					}
				}
			...
			{
				_baseHandlerMessageLogger.LogTrace(traceInfo, idMessage, messageStatus, messageBuilder, detail, transactionContext);
				_baseHandlerMessageLogger.LogCritical(traceInfo, idMessage, messageStatus, x => x.ExceptionInfo(ex), detail, transactionContext);
				throw;
			}
		}
			...
			ITransactionContext? transactionContext = null)
		{
			...
			{
				_baseHandlerMessageLogger.LogDebug(traceInfo, idMessage, messageStatus, messageBuilder, detail, transactionContext);
				_baseHandlerMessageLogger.LogCritical(traceInfo, idMessage, messageStatus, x => x.ExceptionInfo(ex), detail, transactionContext);
				throw;
			}
		}
			...
			ITransactionContext? transactionContext = null)
		{
			...
			{
				_baseHandlerMessageLogger.LogInformation(traceInfo, idMessage, messageStatus, messageBuilder, detail, transactionContext);
				_baseHandlerMessageLogger.LogCritical(traceInfo, idMessage, messageStatus, x => x.ExceptionInfo(ex), detail, transactionContext);
				throw;
			}
		}
			...
			ITransactionContext? transactionContext = null)
		{
			...
			{
				_baseHandlerMessageLogger.LogWarning(traceInfo, idMessage, messageStatus, messageBuilder, detail, transactionContext);
				_baseHandlerMessageLogger.LogCritical(traceInfo, idMessage, messageStatus, x => x.ExceptionInfo(ex), detail, transactionContext);
				throw;
			}
		}
			...
			ITransactionContext? transactionContext = null)
		{
			...
			{
				_baseHandlerMessageLogger.LogError(traceInfo, idMessage, messageStatus, messageBuilder, detail, transactionContext);
				_baseHandlerMessageLogger.LogCritical(traceInfo, idMessage, messageStatus, x => x.ExceptionInfo(ex), detail, transactionContext);
				throw;
			}
		}
			...
			ITransactionContext? transactionContext = null)
		{
			...
			{
				_baseHandlerMessageLogger.LogCritical(traceInfo, idMessage, messageStatus, messageBuilder, detail, transactionContext);
				_baseHandlerMessageLogger.LogCritical(traceInfo, idMessage, messageStatus, x => x.ExceptionInfo(ex), detail, transactionContext);
				throw;
			}
		}
			...
			CancellationToken cancellationToken = default)
		{
			try
			{
				...
				if (messageStatus != MessageStatus.Unchanged)
				{
					...
					{
						await _baseHandlerMessageLogger.LogErrorAsync(traceInfo, idMessage, messageStatus, x => x.ExceptionInfo(ex), detail, transactionContext, cancellationToken);
					}
				}
			...
			{
				await _baseHandlerMessageLogger.LogTraceAsync(traceInfo, idMessage, messageStatus, messageBuilder, detail, transactionContext, cancellationToken);
				await _baseHandlerMessageLogger.LogCriticalAsync(traceInfo, idMessage, messageStatus, x => x.ExceptionInfo(ex), detail, transactionContext, cancellationToken);
				throw;
			}
		}
			...
			CancellationToken cancellationToken = default)
		{
			...
			{
				await _baseHandlerMessageLogger.LogDebugAsync(traceInfo, idMessage, messageStatus, messageBuilder, detail, transactionContext, cancellationToken);
				await _baseHandlerMessageLogger.LogCriticalAsync(traceInfo, idMessage, messageStatus, x => x.ExceptionInfo(ex), detail, transactionContext, cancellationToken);
				throw;
			}
		}
			...
			CancellationToken cancellationToken = default)
		{
			...
			{
				await _baseHandlerMessageLogger.LogInformationAsync(traceInfo, idMessage, messageStatus, messageBuilder, detail, transactionContext, cancellationToken);
				await _baseHandlerMessageLogger.LogCriticalAsync(traceInfo, idMessage, messageStatus, x => x.ExceptionInfo(ex), detail, transactionContext, cancellationToken);
				throw;
			}
		}
			...
			CancellationToken cancellationToken = default)
		{
			...
			{
				await _baseHandlerMessageLogger.LogWarningAsync(traceInfo, idMessage, messageStatus, messageBuilder, detail, transactionContext, cancellationToken);
				await _baseHandlerMessageLogger.LogCriticalAsync(traceInfo, idMessage, messageStatus, x => x.ExceptionInfo(ex), detail, transactionContext, cancellationToken);
				throw;
			}
		}
			...
			CancellationToken cancellationToken = default)
		{
			...
			{
				await _baseHandlerMessageLogger.LogErrorAsync(traceInfo, idMessage, messageStatus, messageBuilder, detail, transactionContext, cancellationToken);
				await _baseHandlerMessageLogger.LogCriticalAsync(traceInfo, idMessage, messageStatus, x => x.ExceptionInfo(ex), detail, transactionContext, cancellationToken);
				throw;
			}
		}
			...
			CancellationToken cancellationToken = default)
		{
			...
			{
				await _baseHandlerMessageLogger.LogCriticalAsync(traceInfo, idMessage, messageStatus, messageBuilder, detail, transactionContext, cancellationToken);
				await _baseHandlerMessageLogger.LogCriticalAsync(traceInfo, idMessage, messageStatus, x => x.ExceptionInfo(ex), detail, transactionContext, cancellationToken);
				throw;
			}
		}
