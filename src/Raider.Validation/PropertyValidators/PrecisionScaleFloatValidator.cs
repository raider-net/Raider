...
{
	internal class PrecisionScaleFloatValidator<T, TProperty> : ValidatorBase<T, TProperty>
	{
		...
		public PrecisionScaleFloatValidator(PropertyValidator<T, TProperty> propertyValidator, int precision, int scale, bool ignoreTrailingZeros)
		...
		{
			if (context.InstanceToValidate is not float value)
				return null;
