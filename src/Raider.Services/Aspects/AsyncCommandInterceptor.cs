...
namespace Raider.Services.Aspects
{
		...
		where TBuilder : CommandHandlerContext.Builder<TContext>
	{
		...
		public AsyncCommandInterceptor(ServiceFactory serviceFactory, ILoggerFactory loggerFactory, ILogger<AsyncCommandInterceptor<TCommand, TResult, TContext, TBuilder>> logger)
			: base(serviceFactory)
		{
