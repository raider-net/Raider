...
namespace Raider.Reflection
{
    ...
    public static class ConstructorExtensions
    {
        ...
        /// any element is <c>null</c> or not, use the overload that accepts <c>paramTypes</c> array.
        /// </remarks>
        /// <seealso cref="CreateInstance(System.Type,System.Type[],Raider.Reflection.Flags,object[])"/>
        ...
        {
			var invocationEmmiter = new CtorInvocationEmitter(type, bindingFlags, parameterTypes);
			invocationEmmiter.GetCallInfo();
			return (ConstructorInvoker)invocationEmmiter.GetDelegate();
		}

		internal static ConstructorInvoker DelegateForCreateInstance(this Type type, out CallInfo callInfo, Flags bindingFlags,
																	params Type[] parameterTypes)
		{
			var invocationEmmiter = new CtorInvocationEmitter(type, bindingFlags, parameterTypes);
			callInfo = invocationEmmiter.GetCallInfo();
			return (ConstructorInvoker)invocationEmmiter.GetDelegate();
		}
		#endregion
