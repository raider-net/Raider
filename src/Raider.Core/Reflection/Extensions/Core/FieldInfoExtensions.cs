...
namespace Raider.Reflection
{
    ...
    public static class FieldInfoExtensions
    {
        ...
        /// Creates a delegate which can set the value of the field identified by <paramref name="fieldInfo"/>.
        /// </summary>
        public static MemberSetter DelegateForSetFieldValueForStruct(this FieldInfo fieldInfo)
        {
            var flags = fieldInfo.IsStatic ? Flags.StaticAnyVisibility : Flags.InstanceAnyVisibility;
            return (MemberSetter)new MemberSetEmitter(fieldInfo, flags).GetDelegateForStruct();
        }
