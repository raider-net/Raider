...
namespace Raider.Reflection
{
    ...
    public static class PropertyInfoExtensions
    {
        ...
        public static MemberSetter DelegateForSetPropertyValueForStruct(this PropertyInfo propInfo)
        {
            var flags = propInfo.IsStatic() ? Flags.StaticAnyVisibility : Flags.InstanceAnyVisibility;
            return (MemberSetter)new MemberSetEmitter(propInfo, flags).GetDelegateForStruct();
        }
