...
namespace Raider.Reflection
{
	...
	public static class MethodExtensions
	{
		...
		/// any element is <c>null</c> or not, use the overload that accepts <c>paramTypes</c> array.
		/// </remarks>
        /// <seealso cref="CallMethod(object,string,System.Type[],Raider.Reflection.Flags,object[])"/>
        internal static object CallMethod(this object obj, string name, Flags bindingFlags, params object[] parameters)
		{
		...
		internal static object CallMethod( this object obj, Type[] genericTypes, string name, Flags bindingFlags, params object[] parameters )
		{
		...
		/// <returns>The return value of the method.</returns>
		/// <remarks>If the method has no return type, <c>null</c> is returned.</remarks>
        internal static object CallMethod(this object obj, string name, Type[] parameterTypes, Flags bindingFlags, params object[] parameters)
		{
        ...
        internal static object CallMethod(this object obj, Type[] genericTypes, string name, Type[] parameterTypes, Flags bindingFlags,
