...
namespace Raider.Validation.Test
{
	public class GreaterThanOrEqualValidatorTest
	{
		...
		public GreaterThanOrEqualValidatorTest(ITestOutputHelper output)
		{
		...
		public void IntNullable(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyIntNullable, x => x.GreaterThanOrEqual(8));
			...
			else
			{
				...
				Assert.Equal(ValidatorType.GreaterThanOrEqual, result.Errors[0].Type);
			}
		}
		...
		public void DecimalNullable(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyDecimalNullable, x => x.GreaterThanOrEqual(8));
		...
		public void DateTimeNullable(ValidationValueType type, bool isValid)
		{
			...
			switch (type)
			{
				...
				case ValidationValueType.Default:
					...
					break;
				case ValidationValueType.Correct:
					person.MyDateTimeNullable = new DateTime(2019, 12, 31);
					break;
				case ValidationValueType.Incorrect:
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyDateTimeNullable, x => x.GreaterThanOrEqual(new DateTime(2019, 12, 31)));
		...
		public void IntNotNull(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyIntNotNull, x => x.GreaterThanOrEqual(8));
		...
		public void DecimalNotNull(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyDecimalNotNull, x => x.GreaterThanOrEqual(8));
		...
		public void DateTimeNotNull(ValidationValueType type, bool isValid)
		{
			...
			switch (type)
			{
				...
				case ValidationValueType.Default:
					...
					break;
				case ValidationValueType.Correct:
					person.MyDateTimeNotNull = new DateTime(2019, 12, 31);
					break;
				case ValidationValueType.Incorrect:
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyDateTimeNotNull, x => x.GreaterThanOrEqual(new DateTime(2019, 12, 31)));
		...
		public void StringNullable(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyStringNullable, x => x.GreaterThanOrEqual("k"));
		...
		public void StringNotNull(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyStringNotNull, x => x.GreaterThanOrEqual("k"));
