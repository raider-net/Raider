...
{
	public class MultiNotEqualValidatorTest
	{
		private readonly ITestOutputHelper _output;

		public MultiNotEqualValidatorTest(ITestOutputHelper output)
		{
		...
		public void IntNullable(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyIntNullable, x => x.NotEqualsTo(validValues));
			...
			else
			{
				...
				Assert.Equal(ValidatorType.MultiNotEqual, result.Errors[0].Type);
			}
		}
		...
		public void DecimalNullable(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyDecimalNullable, x => x.NotEqualsTo(validValues));
		...
		public void DateTimeNullable(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyDateTimeNullable, x => x.NotEqualsTo(validValues));
		...
		public void GuidNullable(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyGuidNullable, x => x.NotEqualsTo(validValues));
		...
		public void IntNotNull(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyIntNotNull, x => x.NotEqualsTo(validValues));
		...
		public void DecimalNotNull(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyDecimalNotNull, x => x.NotEqualsTo(validValues));
		...
		public void DateTimeNotNull(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyDateTimeNotNull, x => x.NotEqualsTo(validValues));
		...
		public void GuidNotNull(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyGuidNotNull, x => x.NotEqualsTo(validValues));
		...
		public void StringNullable(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyStringNullable, x => x.NotEqualsTo(validValues));
		...
		public void StringNotNull(ValidationValueType type, bool isValid)
		{
			...
			var validator = Validator<Person>.Rules()
					.ForProperty(x => x.MyStringNotNull, x => x.NotEqualsTo(validValues));
