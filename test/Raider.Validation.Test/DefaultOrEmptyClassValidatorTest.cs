	...
	public class DefaultOrEmptyClassValidatorTest
	{
		...
		public void StringNullable(ValidationValueType type, bool isValid)
		{
			...
			else
			{
				...
				Assert.Equal(ValidatorType.DefaultOrEmptyClass, result.Errors[0].Type);
			}
		}
		...
		public void ObjectNullable(ValidationValueType type, bool isValid)
		{
			...
			var validator = new Validator<Person>()
					.ForProperty(x => x.MyProfileNullable, x => x.DefaultOrEmpty());
		...
		public void ObjectNotNull(ValidationValueType type, bool isValid)
		{
			...
			var validator = new Validator<Person>()
					.ForProperty(x => x.MyProfileNotNull, x => x.DefaultOrEmpty());
		...
		public void EnumerableNotNull(ValidationValueType type, bool isValid)
		{
			...
			var validator = new Validator<Person>()
					.ForProperty(x => x.MyAddressesNotNull, (ClassPropertyValidator<Person, System.Collections.Generic.IEnumerable<Address>> x) => x.DefaultOrEmpty());
